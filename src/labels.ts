...
export const CompanionLabels = {
	...
	playlistRestartAdvice:
		'Note that the restart for playlist will only execute when in Director: user interaction is enabled, playlist has at least one item and timeline is deactivated.',
